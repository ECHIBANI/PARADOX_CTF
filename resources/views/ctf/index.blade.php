    ...
    <div class="row justify-content-end">
        <div class="col-lg-3 col-md-5">
            <div class="ctf-progress-card">
                <div class="ctf-progress-trophy"><i class="bi bi-trophy-fill"></i></div>
                <div class="ctf-progress-pts">{{ number_format($userStats['total_points']) }} pts</div>
                <div class="ctf-progress-label">{{ $userStats['solved_count'] }} challenge{{ $userStats['solved_count'] != 1 ? 's' : '' }} résolu{{ $userStats['solved_count'] != 1 ? 's' : '' }}</div>
                <div class="ctf-progress-bar-wrap">
                    @php $level = floor($userStats['total_points'] / 500) + 1; $nextLevel = $level * 500; $pct = min(100, ($userStats['total_points'] % 500) / 5); @endphp
                ...
                <div class="ctf-sidebar-card mb-4">
                    ...
                    <div class="ctf-top-player">
                        <div class="ctf-player-rank">
                            @if($index === 0) <i class="bi bi-trophy-fill" style="color:#f59e0b"></i>
                            @elseif($index === 1) <i class="bi bi-trophy-fill" style="color:#94a3b8"></i>
                            @else <i class="bi bi-trophy-fill" style="color:#a16207"></i>
                            @endif
                        </div>
                    ...
                    <div class="ctf-top-player">
                        <div class="ctf-player-rank"><i class="bi bi-trophy-fill" style="color:#f59e0b"></i></div>
                        <div class="ctf-player-avatar">N</div>
                        <div class="ctf-player-info"><div class="ctf-player-name">NitroMonkey</div></div>
                        <div class="ctf-player-pts">4 250 pts</div>
                    </div>
                    <div class="ctf-top-player">
                        <div class="ctf-player-rank"><i class="bi bi-trophy-fill" style="color:#94a3b8"></i></div>
                        <div class="ctf-player-avatar">0</div>
                        <div class="ctf-player-info"><div class="ctf-player-name">0xSpeedy</div></div>
                        <div class="ctf-player-pts">3 750 pts</div>
                    </div>
                    <div class="ctf-top-player">
                        <div class="ctf-player-rank"><i class="bi bi-trophy-fill" style="color:#a16207"></i></div>
                        <div class="ctf-player-avatar">H</div>
                        <div class="ctf-player-info"><div class="ctf-player-name">HexRacer</div></div>
